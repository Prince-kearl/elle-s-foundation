    ...
    <section className="relative isolate flex min-h-[calc(100svh-5rem)] items-end overflow-hidden bg-[#073b2b] text-white">
      ...
      <div className="container-wide relative flex w-full flex-col items-center justify-between pb-8 pt-16 sm:pb-10 md:min-h-[calc(100svh-5rem)] md:items-start md:pt-28">
        ...
        <div className="mt-16 flex flex-col justify-between gap-6 border-t border-white/20 pt-5 text-xs text-white/70 md:flex-row md:items-end">
          <a
            href="#about"
            className="group inline-flex items-center gap-3 font-bold uppercase tracking-[0.2em] text-[#cdeca7]"
          >
            <span className="grid size-9 place-items-center rounded-full border border-[#cdeca7]/50 transition group-hover:bg-[#cdeca7] group-hover:text-[#073b2b]">
            ...
            <div className="flex -space-x-2">
              {[
                ...
                <img
                  ...
                  src={image}
                  alt=""
                  className="size-8 rounded-full border-2 border-[#073b2b] object-cover"
    ...
    <section className="border-b border-[#0f6848]/10 bg-[#f1fae9] py-8 md:py-10">
      <div className="container-wide">
        <div className="mb-5 flex items-center justify-between gap-4">
          <div className="text-[0.62rem] font-bold uppercase tracking-[0.2em] text-[#477763]">
            Impact snapshot
          </div>
          <div className="inline-flex items-center gap-2 text-[0.62rem] font-bold uppercase tracking-[0.16em] text-[#0f6848]">
          ...
          {stats.map(({ value, label, note, Icon, tone }) => (
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div>
                  <div className="font-display text-3xl font-semibold leading-none text-[#073b2b] md:text-4xl">
                    {value}
                  </div>
                  <div className="mt-2 text-[0.62rem] font-bold uppercase tracking-[0.14em] text-[#477763]">
                    {label}
                  </div>
                </div>
                <span
    ...
    <section id="events" className="border-y border-[#0f6848]/10 bg-[#f5f3ea] py-12 md:py-16">
      <div className="container-wide">
        <div className="mb-8 flex flex-col justify-between gap-5 md:flex-row md:items-end">
          ...
          <p className="max-w-md text-sm leading-7 text-[#477763] md:text-right">
        ...
        <div className="grid gap-4 lg:grid-cols-[0.3fr_1fr]">
          <div className="soft-card bg-[#073b2b] p-5 text-white">
            <div className="flex items-start justify-between gap-3 border-b border-white/15 pb-5">
              <div>
                <div className="text-[0.6rem] font-bold uppercase tracking-[0.2em] text-[#cdeca7]">
                  Upcoming
                </div>
          ...
          <div className="grid gap-3">
            {events.map((event) => (
              ...
              >
                <div className="grid size-16 place-items-center border border-[#0f6848]/15 bg-[#fbfff8] text-center">
                  <div>
                ...
                <div>
                  <div className="flex flex-wrap items-center gap-2 text-[0.6rem] font-bold uppercase tracking-[0.14em] text-[#477763]">
                    <span className="size-2" style={{ backgroundColor: event.accent }} />{" "}
                    {event.type}
                  </div>
                  <h3 className="mt-2 font-display text-2xl font-semibold leading-tight text-[#073b2b]">
                    {event.title}
                  </h3>
                  <div className="mt-2 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs font-medium text-[#477763]">
...
function RsvpModal({ event, onClose }: { event: HomepageEvent; onClose: () => void }) {
  ...
  return (
    <div
      className="fixed inset-0 z-[60] grid place-items-center bg-[#073b2b]/70 p-4"
      role="dialog"
      aria-modal="true"
    ...
    >
      <div
        className="w-full max-w-xl border border-[#0f6848]/20 bg-white shadow-2xl"
      ...
      >
        <div className="flex items-start justify-between border-b border-[#0f6848]/10 p-6">
          <div>
            ...
            <p className="mt-2 text-sm text-[#477763]">{event.meta}</p>
          </div>
          <button
            type="button"
            aria-label="Close RSVP form"
            onClick={onClose}
            className="border border-[#0f6848]/15 px-3 py-2 text-sm font-bold text-[#073b2b] hover:bg-[#f1fae9]"
          >
            Esc
          </button>
        </div>
        {submitted ? (
          <div className="p-8">
            ...
            <h4 className="mt-5 font-display text-2xl text-[#073b2b]">You’re on the list.</h4>
            <p className="mt-2 text-sm leading-7 text-[#477763]">
              Thank you for registering. We’ll contact you with event details and updates.
            </p>
            <button
              type="button"
              onClick={onClose}
              className="mt-6 bg-[#073b2b] px-5 py-3 text-sm font-bold text-white"
            >
              Close
            </button>
          </div>
          ...
          <form onSubmit={submit} className="grid gap-4 p-6 sm:grid-cols-2">
            <label className="text-xs font-bold uppercase tracking-[0.14em] text-[#477763]">
              Full name
              <input
                required
                value={name}
            ...
            <div className="flex items-center justify-between gap-4 border-t border-[#0f6848]/10 pt-4 sm:col-span-2">
              <p className="text-xs leading-5 text-[#477763]">
      ...
      <div className="container-wide grid items-center gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:gap-24">
        <div className="relative">
          ...
          <div className="absolute -bottom-6 -right-3 max-w-[15rem] rounded-2xl bg-white p-5 shadow-[0_22px_50px_-25px_rgba(15,104,72,0.4)] sm:-right-7">
            <div className="flex items-center gap-2 text-[#0f6848]">
              <span className="grid size-8 place-items-center rounded-full bg-[#f1fae9]">
            ...
            <p className="mt-3 text-sm leading-5 text-[#477763]">
        ...
        <div className="max-w-2xl">
          ...
          <p className="mt-7 max-w-xl text-base leading-8 text-[#477763] md:text-lg">
            {pv(
              c,
              "about.description",
          ...
          <div className="mt-8 grid max-w-xl grid-cols-2 gap-5 border-y border-[#0f6848]/15 py-7 sm:grid-cols-4 sm:gap-4">
            {impactStats.map(({ value, label }) => (
              <div key={label}>
                <div className="font-display text-2xl font-semibold text-[#0f6848] md:text-3xl">
                  {value}
                </div>
                <div className="mt-1 text-[0.59rem] font-bold uppercase tracking-[0.12em] text-[#477763]">
                  {label}
                </div>
              </div>
            ))}
        ...
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          {programs.map(({ icon: Icon, number, title, label, text, image }) => (
            <Link
              key={title}
              to="/programs"
              className="group block overflow-hidden rounded-[1.2rem] border border-[#0f6848]/10 bg-white shadow-[0_18px_45px_-35px_rgba(15,104,72,0.5)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_25px_50px_-30px_rgba(15,104,72,0.4)]"
            >
              <div className="relative aspect-[1.12] overflow-hidden bg-[#cdeca7]">
                <img
                  src={image}
                  alt={title}
              ...
              <div className="p-6">
                ...
                <div className="mt-5 flex items-center gap-2 text-sm font-bold text-[#0f6848]">
                  Learn more{" "}
        ...
        <div className="order-1 max-w-xl lg:order-2 lg:pl-8">
          ...
          <div className="mt-7 grid gap-3 sm:grid-cols-2">
            {checks.map((item) => (
              <div
                key={item}
                className="flex items-center gap-2 text-sm font-semibold text-[#0f6848]"
              >
                <span className="grid size-5 place-items-center rounded-full bg-[#0f6848] text-white">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 rounded-full border border-[#0f6848]/20 px-6 py-3 text-sm font-bold text-[#0f6848] transition hover:bg-white"
            >
      ...
      <div className="container-wide">
        <div className="relative overflow-hidden rounded-[1.5rem] bg-[var(--gold)] px-7 py-12 text-[#073b2b] md:px-14 md:py-16">
          ...
          <div className="relative grid items-end gap-10 lg:grid-cols-[1.2fr_0.8fr]">
            <div className="max-w-2xl">
              <div className="mb-5 flex items-center gap-3 text-[0.66rem] font-bold uppercase tracking-[0.22em] text-[#084b35]">
                <span className="size-2 rounded-full bg-[#cdeca7]" /> Get involved
              </div>
              <h2 className="font-display text-4xl font-semibold leading-[1.02] tracking-[-0.05em] md:text-6xl">
                {pv(c, "cta.title", "Be the reason someone's life changes.")}
              </h2>
              <p className="mt-5 max-w-xl text-base leading-7 text-[#084b35]/75 md:text-lg">
                {pv(
                  c,
                  "cta.description",
            ...
            <div className="flex flex-wrap gap-3 lg:justify-end">
              ...
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 rounded-full border border-[#073b2b]/25 bg-white/25 px-6 py-3.5 text-sm font-bold text-[#073b2b] transition hover:bg-white/45"
              >
                Volunteer
              </Link>
            </div>
